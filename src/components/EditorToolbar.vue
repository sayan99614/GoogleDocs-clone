<template>
  <div class="md:mx-4">
    ...
    >
      ...
      <span @click="emit('undo')" class="toolbar-icon-container"><ArrowUturnLeftIcon class="toolbar-icon" /></span>
      <span @click="emit('redo')" class="toolbar-icon-container"><ArrowUturnRightIcon class="toolbar-icon" /></span>
